...
<html>
    <head>
        ...
        <spring:url value="/resources/css/update.css" var="updateCss" />
        ...
        <style>
            ...
            body {
                ...
                /*background:url(resources/css/background2.jpg) no-repeat center center fixed;*/
    ...
    <body>
        ...
        <div class="container" >
            <form:form class="well form-horizontal" style="background: none;  background-image: none;" action="updateCV" method="post" name="newCVForm" commandName="updatecV" enctype="multipart/form-data" >
                <form:hidden path="cvID" />
                <fieldset>

                    <legend>Update your CV</legend>
                    ...
                    <c:forEach items="${allInputModels}" var="i">
                        ...
                        <c:if test="${cvID == cvID2}">
                            ...
                            <c:choose>
                                <c:when test="${i.image != null}">


                                    <img height="200px" width="200px" style="border-radius: 50%;margin-left: 40%;"  src="<c:url value="resources/imagess/${i['image']}" />" alt="" />

                                    <div class="row">    
                                        <div class="col-xs-12 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">  
                                            <p><strong>Change picture for CV</strong></p>
                                            ...
                                            <div class="input-group image-preview">
                                                ...
                                                <span class="input-group-btn">
                                                    ...
                                                    <div class="btn btn-default image-preview-input">
                                                        <span class="glyphicon glyphicon-folder-open"></span>
                                                        <span class="image-preview-input-title">Browse</span>
                                                        <input type="file" accept="image/png, image/jpeg, image/gif, image/bmp" name="images"/> <!-- rename it -->
                                                    </div>
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                ...
                                <form:textarea  path="workExperience1" class="form-control" id="workExperience1" name="workExperience1" placeholder="Work Experience"></form:textarea>
                                    <script>
                                        CKEDITOR.replace('workExperience1');
                                    </script>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <script>
                                            CKEDITOR.replace('workExperience2');
                                        </script>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <script>
                                            CKEDITOR.replace('workExperience3');
                                        </script>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="divJob4">
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-briefcase"></i></span>
                                        <form:input id="dayPicker2" path="firstDayJob4"  name="firstDayJob4" class="datepicker form-control"  placeholder="First Day" readonly="true" />
                                    ...
                                    <form:textarea  path="workExperience4" class="form-control" id="workExperience4" name="workExperience1" placeholder="Work Experience"></form:textarea>
                                        <script>
                                            CKEDITOR.replace('workExperience4');
                                        </script>
                                    </div>
                                </div>
                            </div>
                    ...
                    <c:forEach items="${allInputModels}" var="i">
                        ...
                        <c:if test="${cvID == cvID2}">
                            ...
                            <c:choose>
                                <c:when test="${i.pdf1 != null}">
                                    <div style="margin-left: 40%;"><p >Uploaded file: <strong>${i.pdf1}</strong></p> </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Change uploaded file ...</label>  
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-education"></i></span>

                                                <input id="input-2" name="pdfs1" type="file" class="file" multiple data-show-upload="false" data-show-caption="true">
                                            </div>
                                        </div>
                                    </div><br/>
                                </c:when>    
                                <c:otherwise>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Certificates, diplomas, etc ...</label>  
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-education"></i></span>
                                                <input id="input-2" name="pdfs1" type="file" class="file" multiple data-show-upload="false" data-show-caption="true">
                    ...
                    <c:forEach items="${allInputModels}" var="i">
                        ...
                        <c:if test="${cvID == cvID2}">
                            ...
                            <c:choose>
                                <c:when test="${i.pdf2 != null}">

                                    <div style="margin-left: 40%;"><p >Uploaded file: <strong>${i.pdf2}</strong></p></div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Change uploaded file ...</label>  
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-education"></i></span>
                                                <input id="input-2" name="pdfs2" type="file" class="file" multiple data-show-upload="false" data-show-caption="true">
                                            </div>
                                        </div>
                                    </div><br/>
                                </c:when>    
                    ...
                    <c:forEach items="${allInputModels}" var="i">
                        ...
                        <c:if test="${cvID == cvID2}">
                            ...
                            <c:choose>
                                <c:when test="${i.pdf3 != null}">

                                    <div style="margin-left: 40%;"><p >Uploaded file: <strong>${i.pdf3}</strong></p> </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Change uploaded file ...</label>  
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-education"></i></span>
                                                <input id="input-2" name="pdfs3" type="file" class="file" multiple data-show-upload="false" data-show-caption="true">
                                            </div>
                                        </div>
                                    </div><br/>
                    ...
                    <c:forEach items="${allInputModels}" var="i">
                        ...
                        <c:if test="${cvID == cvID2}">
                            ...
                            <c:choose>
                                <c:when test="${i.pdf4 != null}">

                                    <div style="margin-left: 40%;"><p >Uploaded file: <strong>${i.pdf4}</strong></p> </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Change uploaded file ...</label>  
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-education"></i></span>
                                                <input id="input-2" name="pdfs4" type="file" class="file" multiple data-show-upload="false" data-show-caption="true">
                                            </div>
                                        </div>
                                    </div><br/>
                                </c:when>    
